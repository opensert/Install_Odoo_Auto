...
WKHTMLTOX_X32=https://nightly.odoo.com/extra/wkhtmltox-0.12.1.2_linux-jessie-amd64.deb
WKHTMLTOX_X32=https://nightly.odoo.com/extra/wkhtmltox-0.12.1.2_linux-jessie-i386.deb
...
echo -e "\n---- Creating the WGODOO PostgreSQL User  ----"
...
echo -e "\n---- Create WGODOO system user ----"
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'WGODOO' --group $OE_USER
